...
const ProfileCard: React.FC = () => {
    ...
    const socialLinks = [
        {
            name: 'Email',
            href: 'Naphatsnan.khun@bumail.net+',
            icon: (
        ...
        {
            name: 'Facebook',
            href: 'https://facebook.com/Numing Jayb',
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-center justify-center">
                            <div className="flex items-center space-x-2">
                                ...
                                <div>
                                    <p className="text-white font-medium text-sm sm:text-base">Naphatsnan.khun@bumail.net</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <div>
                                    <p className="text-white font-medium text-sm sm:text-base">0620014318</p>
                                </div>
                            </div>
                        </div>
                    </div>
